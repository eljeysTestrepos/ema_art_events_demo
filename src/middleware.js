...
// Importerer de nødvendige funktioner fra Clerk og Next.js
import { authMiddleware, createRouteMatcher } from "@clerk/nextjs/server";
import { NextResponse } from "next/server"; // Beholder denne import, hvis du får brug for den
...
// Export standard middleware-funktion ved hjælp af authMiddleware fra Clerk
export default authMiddleware({
  ...
  // Genaktiver 'debug: true' for at få mere detaljerede logs under udvikling,
  // det er meget nyttigt for fejlfinding.
  debug: true,
});
